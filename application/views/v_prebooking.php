							...
							<div class="flight-wrapper">
								<div class="search-flight-title">
									...
									<p>
										<b>
											<?php 
												//convert date to month day using function php
									...
									<p>
										<b>
											<span>
												<?php echo $_GET['passengers'] ?> Penumpang,
											</span>
											<span>
												Kelas <?php echo $_GET['flight_class'] ?>
											</span>
										</b>
									</p>
								</div>
								...
								<?php 
											...
											<div class="col-lg-3">
												<p>
													...
													<div class="row">
														<span>Penumpang :</span>
														<span><?php echo $_GET['passengers'] ?></span>
													</div>
													<div class="row">
														<span>Price you Pay :</span>
														<span><!-- convert number to idr format -->
															<?php 
											...
											<!-- form for continue to booking -->
											<div class="row">
											<form action="<?php echo base_url('prebooking/make_booking'); ?>" method="POST">
												<input type="hidden" name="rute_id" value="<?php echo $_GET['id'] ?>">
												<input type="hidden" name="passengers" value="<?php echo $_GET['passengers'] ?>">
												<div class="btn">
													<button class="btn btn-primary">Continue to Booking</button>
												</div>
											</form>
											</div>
										</div>
